						...
						<h4>
							<table class="table table-hover">
								...
								<tr class="<?php echo $color; ?>">
									<td class="id_compras text-center"><?php echo $id_compras; ?></td>
									...
									<td class="text-center">
										...
										<a data-id_compras="<?php echo $id_compras ?>" class="cancelar_compra btn btn-danger" id="cancelar_compra"><i class="fas fa-times"></i></a>
...
$(".cancelar_compra").click(confirma);
...
function confirma() {
	...
	id_compras= $(this).data("id_compras");

	alertify.confirm("¿Cancelar la Compra?", 
	si_cancelar,
	function () {
...
function si_cancelar() {

	console.log("Cancela", id_compras)
		$.ajax({
			url: "cancelar_compra.php",
			data : {
				"id_compras" : id_compras
			}
		}).done(compraCancelada);
	}

function compraCancelada() {
	alertify.success("Compra Cancelada")
}
</script>